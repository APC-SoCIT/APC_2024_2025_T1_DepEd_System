        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid" id="view-student">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <input type="text" id="search-bar" class="form-control" placeholder="Search by name or LRN in Section">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <input type="text" id="search-bar" class="form-control" placeholder="Search by name or LRN in Database">
                        </div>
                    </div>
