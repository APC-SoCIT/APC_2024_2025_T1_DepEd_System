        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                <div class="container-fluid" id="register-student-container">
                    <div>
                        <center><h1 class="pt-3">Update Section</h1></center>
                    </div>
                    <hr>
                        ...
                        <center>
                        <form type="submit" action="{{route('sectionDelete', ['section' => $section->id])}}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger delete-section mt-3">Delete</button>
                        </form>
                        <center>
                </div>
            </main>
