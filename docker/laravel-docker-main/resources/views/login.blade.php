...
>>>>>>> refs/remotes/origin/main
        ...
        <div class='container'>
            ...
            <div class="input-container">
                <a href="{{route('login-student')}}" class="no-effects">
                <div class="radio-tile">
